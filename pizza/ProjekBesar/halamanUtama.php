...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="style/fontFamily.css">>
        <link rel="stylesheet" type="text/css" href="style/utama.css">
	...
	<body>
		...
		<img id="log" src="images/index.jpg" style="width: 20%">
		<div id="box">
        ...
        <div id="id01" class="modal">
			<form class="modal-content animate" action="admin.php">
				<div class="imgcontainer">
					...
					<img src="images/index.jpg" style="width: 20%" class="avatar">
				</div>
				<div class="container">
	...
	<footer class="w3-center w3-black w3-padding-48 w3-xxlarge">
		...
		<p>by RioAurelio, JuanNandrissa, MelodyVictorian
    </footer>
